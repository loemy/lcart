...
@section('title')
  @lang('Length Management') .'|'. @lang('Length Add')  
@endsection

@section('page-header')
<h1>@lang('Length Management')<small> @lang('Add Length')</small></h1>
    ...
    <div class="col-sm-12">
        <div class="box box-pink">
            <div class="box-header">
               <div class="box-title"> @lang('Add Length')</div>
               @role('')
                {!! Form::open(['route' => 'admin.lengths.store', 'class'=>'form-horizontal', 'role' => 'form', 'method'=>'post' 'file'=>true]) !!}
                {{ csrf_field() }} 
